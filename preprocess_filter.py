...
def initial_crop(filepath, plots = {'raw': False, 'cosmic_ray': False, 'outside_zero' : False, 'quant' : False, 'cropped' : False, 'lucy_median': False, 'forrier':False}):
    ...
    # print(f"Warning: Unable to read mask image at {filepath}")
    # reading image
    ...
    pixel_values = remove_cosmic_rays(pixel_values) #YK edit, this is messing too much with the data. causing circular stripes and ring patterns.
